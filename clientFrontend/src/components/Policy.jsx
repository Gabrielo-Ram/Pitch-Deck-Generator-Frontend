  ...
  return (
    <>
      ...
      <div
        ...
        className="policy mx-auto w-[63%] pt-[8%] py-[10%]"
      >
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to AI Pitch-Deck Generator.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to AI Pitch-Deck Generator,
              accessible from{" "}
              <a
                href="https://pitch-deck-generator-frontend.onrender.com"
        ...
        <p>
          Cookies are &quot;Session&quot; Cookies. Session Cookies are deleted
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              Service that are available to You as a registered user. Namely,
              You can not access most features without signing in with Google.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>Will will not share Your Personal Data with anyone.</p>
        <h3>Retention of Your Personal Data</h3>
        <p>
          The Company will retain Your Personal Data only for as long as You are
          engaged with AI Pitch-Deck Generator, or for a maximum of 1 hour. We
        ...
        <p>
          ...
          signing out of Your Account, if you have one, and visiting the account
        ...
        <ul>
          <li className="text-xl">
            By email: <b>gabriel569519@gmail.com</b>
          </li>
        </ul>
      </div>
    </>
