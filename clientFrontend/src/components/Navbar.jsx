...
function Navbar() {
  ...
  return (
    <div className="sm:text-sm border-b-2 border-gray-700 absolute w-screen h-[10%] flex items-center justify-between overflow-hidden">
      <h1 className="md:text-3xl font-bold px-[5%]">
        <div onClick={navigateHome} className="hover:cursor-pointer">
          AI Pitch-Deck Template Generator
        </div>
      </h1>

      <div className="flex justify-between w-[40%] md:w-1/4 h-full items-center px-[5%]">
        <div
          onClick={navigatePolicy}
          className="flex justify-center items-center h-[70%] hover:cursor-pointer hover:text-blue-500"
        >
          <p className="underline md:text-lg">Privacy Policy</p>
        </div>
